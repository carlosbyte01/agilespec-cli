...
- `DDD-GLOSSARY.md`, is the DDD index file containing just the **Ubiquitous Language**. This is recommended for entry level users, or when working on basic projects that do not require a detailed understanding of the domain. Sample of a **DDD-GLOSSARY.md** file: [DDD-GLOSSARY-SAMPLE.md](./references/DDD-GLOSSARY-SAMPLE.md)
- `DDD-MAP.md`, is the comprehensive DDD reference document mapping our **Domain Taxonomy**, **Bounded Contexts**, and **Ubiquitous Language**. This is recommended for advance users working on complex projects that need a detailed understanding of the domain. Sample of a **DDD-MAP.md** file: [DDD-MAP-SAMPLE.md](./references/DDD-MAP-SAMPLE.md)
